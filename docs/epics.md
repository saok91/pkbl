...
| ۲ | E5, E6, E12 | ویرایشگر + امتیاز live |
...
**معیار پذیرش:**
- [ ] debounce ~100–150ms
- [ ] امتیاز کلی prominent — **بالاتر بهتر**
- [ ] loading state بدون flicker
- [ ] preset selector (wiki-fa / varzesh3)
...
**معیار پذیرش:**
- [ ] نمایش: unigram, bigram, trigram scores
- [ ] home row %, hand balance
- [ ] same-finger / same-hand bigram counts
- [ ] row switching metric
- [ ] weak key penalty
...
**معیار پذیرش:**
- [ ] ranked list یا heat overlay روی keyboard
- [ ] top 10 hotspots
- [ ] link hotspot → key روی keyboard
...
**معیار پذیرش:**
- [ ] template-based hints از breakdown (مثلاً «بار انگشت کوچک بالاست»)
- [ ] فارسی، concise
- [ ] بدون LLM در v1
