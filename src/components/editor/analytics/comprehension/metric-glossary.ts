...
export const METRIC_GLOSSARY: readonly GlossaryEntry[] = [
  {
    termFa: "n-gram",
    definitionFa: "الگوی چند حرف پشت‌سرهم در متن — پایهٔ محاسبهٔ هزینهٔ تایپ.",
  },
  {
    termFa: "یونی‌گرام",
  ...
  },
  {
    ...
    definitionFa:
      "دو حرف پشت‌سرهم که با یک انگشت تایپ می‌شوند — کند و خسته‌کننده.",
  },
  {
  ...
  },
  {
    ...
    definitionFa:
      "مجموع هزینهٔ تایپ تک‌حرف‌ها قبل از نرمال‌سازی — فقط برای متخصص.",
  },
  {
    termFa: "هزینه خام بی‌گرام",
    definitionFa:
      "مجموع هزینهٔ توالی‌های دوحرفی قبل از نرمال‌سازی — فقط برای متخصص.",
  },
  {
    termFa: "هزینه خام تری‌گرام",
    definitionFa:
      "مجموع هزینهٔ توالی‌های سه‌حرفی قبل از نرمال‌سازی — فقط برای متخصص.",
  },
] as const;
