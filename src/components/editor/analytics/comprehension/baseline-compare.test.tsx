...
describe("BaselineCompare", () => {
  it("shows positive delta when layout beats baseline", () => {
    render(
      <BaselineCompare total={1180} baselineTotal={1000} isStale={false} />,
    );
  ...
  it("shows negative delta when layout is worse than baseline", () => {
    render(
      <BaselineCompare total={850} baselineTotal={1000} isStale={false} />,
    );
  ...
  it("shows equal message when scores match", () => {
    render(
      <BaselineCompare total={1000} baselineTotal={1000} isStale={false} />,
    );
